var str1=` <form id='form_data' method='post' enctype='multipart/form-data'> <div class="mess">
<div class="mess-nav">
  <span>1.基本信息</span>
  <span
...
//发布任务
var str2=`<form id='form_data2' method='post' enctype='multipart/form-data'>
<div class="part2">
<div class="part3-left">
  ...
  <div>
    ...
    <p class="give-time">
      <label for="">需求人数<span>*</span></label>
      <input type="text" class="demand_num"/>
      <label for="">岗位薪资<span>*</span></label>
      <input type="text" placeholder="输入薪资" class="jobs_salary"/>
    </p>
    <p class="type-check project_state">
      <label for="">工程状态</label>
    ...
    <p class="give-time">
        ...
        <label for="">工种<span>*</span></label>
        <select class="demand_job_id">
          <option value="0">泥工</option>
          <option value="1">架子工</option>
          <option value="2">焊工</option>
          <option value="3">钢筋工</option>
          <option value="4">抹灰工</option>
          <option value="5">钢结构安装工</option>
          <option value="6">油漆工</option>
          <option value="7">管道工</option>
          <option value="8">防水工</option>
          <option value="9">电工</option>
...
var str4=`<div class="part4 part"></div>`;
var str5=`<div class="part5 part"></div>`;
var str6=`<div class="part6 part"></div>`;
